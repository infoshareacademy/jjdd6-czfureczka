...
public class StopTimes {
    ...
    public StopTimes(int routeId, int tripId, int agencyId, String arrivalTime, String departureTime, int stopId, int stopSequence, String date, String busServiceName, int nonpassenger, int onDemand, int virtual, String stopShortName) {
        this.routeId = routeId;
        this.tripId = tripId;
        this.agencyId = agencyId;
        this.arrivalTime = arrivalTime;
